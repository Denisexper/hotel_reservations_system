  ...
  return (
    <aside class="w-64 min-h-screen border-r border-gray-200 dark:border-gray-800 
      ...
      <nav class="flex-1 px-3 py-4 space-y-1">
        ...
        {/* Catálogos - Solo si tiene permiso */}
        <Show when={auth.hasPermission('catalogs.read')}>
          <A href="/catalogs" class={navLinkClass('/catalogs')}>
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {/* Day Pass Solo si tiene permiso */}
        <Show when={auth.hasPermission('daypass.read')}>
          <A href="/daypass" class={navLinkClass('/daypass')}>
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {/* Temporadas de Precios - Solo admin/gerente */}
        <Show when={auth.hasPermission('rooms.create')}>
          <A href="/seasonal-prices" class={navLinkClass('/seasonal-prices')}>
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {/* Mantenimiento */}
        <Show when={auth.hasPermission('maintenance.read')}>
          <A href="/maintenance" class={navLinkClass('/maintenance')}>
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
